...
export const SuggestionList = ({onSearchResultSelect, onSearchResultsKeyDown, onActionKeyDown, selectedAction, highlightedIndex, suggestions, displayAction}: SuggestionListProps) => {
    return (
